...
<p align="center">
  <a href="https://www.gatsbyjs.org">
    <img alt="Gatsby" src="./static/gatsbyMilligramLogo.png" width="1124" height="456" />
  </a>
</p>
<h1 align="center">
...
1.  **Create a Gatsby site.**
    ...
    Use the Gatsby CLI to create a new site, specifying the milligram starter.

    ```shell
    # create a new Gatsby site using the hello-world starter
    gatsby new milligram-starter https://github.com/prasademc/gatsby-starter-milligram
    ```
...
[![Deploy with ZEIT Now](https://zeit.co/button)](https://zeit.co/import/project?template=https://github.com/prasademc/gatsby-starter-milligram)
